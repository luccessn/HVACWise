    ...
    20L44 20L44 22L36 22ZM36 27L44 27L44 29L36 29ZM36 35L44 35L44 37L36 37Z"
      ...
      {clear && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
          <div className="group select-none w-[320px] flex flex-col p-6 items-center justify-center bg-gray-800 border border-gray-700 shadow-xl rounded-2xl">
            ...
            0V8a1 1 0 00-1-1z"
              ...
              <p className="font-bold text-sm text-gray-400 px-2">
                დაიმახსოვრე გასუფთავებული ინფორმაცია ვეღარ აღდგება.
              </p>
            </div>
            <div className="p-2 mt-4 text-center space-x-2 md:block">
              <button
                onClick={() => setclear(false)}
                className="mb-2 md:mb-0 bg-gray-700 px-5 py-2 text-sm shadow-sm font-medium tracking-wider border border-gray-600 hover:border-gray-500 text-gray-300 rounded-full hover:shadow-lg hover:bg-gray-800 transition ease-in duration-200"
              >
                Cancel
              </button>
              <button
                onClick={() => {
                  dispatch(clearFullHVAC());
                  setclear(false);
                }}
                className="bg-red-500 hover:bg-transparent px-5 ml-2 py-2 text-sm shadow-sm hover:shadow-lg font-medium tracking-wider border border-red-500 hover:border-red-500 text-white hover:text-red-500 rounded-full transition ease-in duration-200"
              >
                Confirm
              </button>
            </div>
